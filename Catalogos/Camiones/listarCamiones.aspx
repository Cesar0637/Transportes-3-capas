<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="listarCamiones.aspx.cs" Inherits="Transportes_3_capas.Catalogos.Camiones.listarCamiones" %>
        ...
        <div class="row">
            <asp:GridView ID="GVCamiones" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Tipo_Camion" HeaderText="Tipo de Camion"
                        ItemStyle-Width="85px" ReadOnly="true" />
                    ...
                    <asp:ImageField HeaderText ="Foto" ReadOnly="true" ItemStyle-Width="120px"
